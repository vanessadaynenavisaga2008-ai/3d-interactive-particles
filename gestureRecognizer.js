 ...
 * Defines window.GestureDetector — the piece gestureDetector.js
 * calls (GestureDetector.analyze(...)) but never actually defines.
 *
 * Turns raw MediaPipe hand landmarks into:
 *   {
 *     palmCenter:      { x, y }   // pixel coords, in video space
 *     pinchIntensity:  0..1       // thumb tip <-> index tip closeness
 *     fistIntensity:   0..1       // how curled all fingers are
 *     isPeaceSign:     boolean    // index+middle extended, ring+pinky curled
 *   }
 */
